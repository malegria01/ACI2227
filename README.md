...
2.0 Material Suplementario: Tutorial de diagramas de Clases con `UML`: Esta [aplicación](https://www.lucidchart.com/pages/es/tutorial-de-diagrama-de-clases-uml) deja realizar hasta 3 proyectos gratuitos de UML
